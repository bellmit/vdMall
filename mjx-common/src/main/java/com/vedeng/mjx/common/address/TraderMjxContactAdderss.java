package com.vedeng.mjx.common.address;

import java.io.Serializable;

public class TraderMjxContactAdderss implements Serializable{
	private String phone;//用户手机号
	private String deliveryUserName;//收货人名称 accountName
	private Integer deliveryAddressId;//收货地址ID 不传
	private String deliveryUserAddress;//收件人地址 addressInfo
	private String deliveryUserPhone;//收件人手机 phone
	private String deliveryLevel1Id;//省Id regionIds[0]
	private String deliveryLevel2Id;//市id regionIds[2]
	private String deliveryLevel3Id;//区id regionIds[3]
	private String deliveryAreaIds;//省市区id  regionIds
	private String titleName;//标签名称
	private Integer isEnable;//是否有效 0否 1是
	/** 是否默认收货地址 0否 1是  IS_DELIVERY_DEFAULT **/
    private Integer isDeliveryDefault; //isDefAddress

    /** 是否默认收票地址 0否 1是  IS_INVOICE_DEFAULT **/
    private Integer isInvoiceDefault; //isDefTicket
    
    private Integer mjxContactAdderssId; //MJX主键 accountAddressId
